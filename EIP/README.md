...
to share their honest thoughts abot a product yet remain anaomymous (if one chooses to be). Peer to peer review system works by puting 
...
a distributed stratum level0 server after proof of consensus over the real transaction```
